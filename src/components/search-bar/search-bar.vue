<template>
    <div>
        <div class="search">
            ...
            <div class="content">
                <!-- <van-search v-model="value" placeholder="关键字/位置/名宿" /> -->
...
import { formatMonthDay_1 } from '@/utils/format_date';
import { computed } from '@vue/reactivity';
import {storeToRefs} from 'pinia';

const mainStore = useMainStore();
const {startDate, endDate} = storeToRefs(mainStore);
const startDateStr = computed(() => formatMonthDay_1(startDate.value))
const endDateStr = computed(() => formatMonthDay_1(endDate.value))
