<template>
    <div class="recommend">
        <!-- <detail-section title="热门评论" :moreText="moreText()" #content></detail-section> -->
        <detail-section title="热门评论" :more-text="`查看全部${comment.totalCount}条评论`" #content>
                ...
                <div class="header">
                    <div class="left">
                        ...
                        <div class="info">
                            ...
                            <div class="star">
                                <van-rate v-model="comment.overall" :count="5" allow-half color="#ff9645" size="12" readonly />
                            </div>
                        </div>
                    </div>
                    <div class="right">
...
// const moreText = () => {return `查看全部${props.comment.totalCount}条评论`};
